  ...
  static collectRequestParams(request) {
    ...
    if (request.openapi.schema.requestBody !== null) {
      ...
      if (content['application/json'] !== undefined) {
        ...
        console.log('📥 Request body name:', requestBodyName);
        console.log('📥 Request body content:', request.body);
        
        // ✅ SOLUCIÓN: Si el body es un objeto con propiedades directas, expandirlas
        if (requestBodyName === 'body' && request.body && typeof request.body === 'object') {
          // Para endpoints personalizados sin schema $ref, expandir las propiedades
    ...
    // ✅ DEBUG: Ver los parámetros finales
    console.log('📥 Parámetros finales para el servicio:', requestParams);
