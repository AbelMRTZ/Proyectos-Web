...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'VendoTuttoSport_ea98b10de5d0efd83352_20260505103503_archive.zip';
        const ARCHIVE_SIZE       = '89626482';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ea98b10-05103503';
        const SECONDARY_PACKAGE_HASH = 'd76faf3-05103503';
